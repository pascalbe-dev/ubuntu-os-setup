...
# or they might be shared by the organization
...
read -p "Now import the certificates under '/usr/local/share/ca-certificates/custom/' to the browser. Then press Enter"
